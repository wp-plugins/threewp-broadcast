jQuery(document).ready(function($) {
	...
	$( '.broadcast_to', $broadcast ).append(" \
		<p style=\"text-align: center;\"> \
		<span class=\"selection_change select_deselect_all\">" + broadcast_strings.select_deselect_all + "</span> \
		&emsp; \
		<span class=\"selection_change invert_selection\">" + broadcast_strings.invert_selection + "</span> \
		</p> \
	");
